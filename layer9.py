...
menu_frame = Frame(root, bd=0, width=900, height=900,bg="#FFF7D9")
menu_frame.pack(side="top", fill="both", padx=50,pady=60, expand=True)
...
def Menu_button():
    menu_button= Button(menu_frame,text='Start', command=Display(data), width=20)
    menu_button.pack()
